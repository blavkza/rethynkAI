  ...
  return (
    <>
      ...
      <div className="">
        ...
        {todayList.length > 0 && (
          <div>
            <h3 className="dark:text-white text-zinc-900 font-semibold mt-4">
              Today
            </h3>
            {todayList.map((workplace) => (
              <Link key={workplace._id} href={`/workplace/${workplace._id}`}>
                <h2
                  ...
                  className="dark:text-zinc-400 text-zinc-700 mt-2 dark:hover:text-white hover:text-zinc-400 cursor-pointer truncate"
                >
